...
World::build(void) {
	...
	image_ptr->read_ppm_file("F:/Documents/Visual Studio 2005/Projects/Rytracer/TextureFiles/ppm/EveningSky.ppm");			// for Figure 29.27(a)
//	image_ptr->read_ppm_file("MorningSky.ppm");			// for Figure 29.27(b)	
	...
	hemisphere_ptr->set_shadows(false); //这个导致了我的光照比较暗
	hemisphere_ptr->scale(1000000.0,1000000.0,1000000.0);
