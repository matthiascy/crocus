...
World::build(void) {
	...
	//glass_ptr->set_ka(0.3);
	//glass_ptr->set_kd(0.3);
	//glass_ptr->set_cd(0.1);
	...
	//water_ptr->set_ka(0.3);
	//water_ptr->set_kd(0.3);
	//water_ptr->set_cd(0.8);
	//water_ptr->set_ks(0.2);
	...
	//dielectric_ptr->set_ka(0.3);
	//dielectric_ptr->set_kd(0.3);
	//dielectric_ptr->set_cd(0.8);
	...
	checker_ptr->set_color1(RGBColor(0.75)); 
