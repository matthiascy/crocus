...
World::build(void) {
	...
	image_ptr->read_ppm_file("F:/Documents/Visual Studio 2005/Projects/Rytracer/TextureFiles/ppm/uffizi_probe_small.ppm");   // for development
//	image_ptr->read_ppm_file("F:/Documents/Visual Studio 2005/Projects/Rytracer/TextureFiles/ppm/uffizi_probe_large.ppm");   // for production
	...
	sphere_ptr->scale(1000000,1000000,1000000);
