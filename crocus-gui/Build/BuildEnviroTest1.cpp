...
World::build(void) {
	...
	image_ptr->read_ppm_file("F:/Documents/Visual Studio 2005/Projects/Rytracer/TextureFiles/ppm/CyanToYellow.ppm");
	...
	Sphere* sphere_ptr = new Sphere(Point3D(0, 40, 0), 40);
