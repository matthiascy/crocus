...
FishBowl* FishBowl::clone(void) const 
{
	return(new FishBowl(*this));
}

FishBowl& FishBowl::operator= (const FishBowl& rhs) 
{
	if (this == &rhs)
		return (*this);
...
void FishBowl::build_components(void) 
{
...
void FishBowl::set_glass_air_material(Material* m_ptr) 
{
	for (int j = 0; j < 3; j++)
...
void FishBowl::set_water_air_material(Material* m_ptr) 
{
...
void FishBowl::set_water_glass_material(Material* m_ptr) 
{
