...
World::build(void) {
	...
	Sphere* sphere_ptr = new Sphere(Point3D(), radius);
...
//	image_ptr->read_ppm_file("d:/uffizi_probe_small.ppm");   // for testing 
	image_ptr->read_ppm_file("d:/uffizi_probe_large.ppm");   // for production
	...
	sphere_ptr1->scale(1000000.0,1000000.0,1000000.0);
